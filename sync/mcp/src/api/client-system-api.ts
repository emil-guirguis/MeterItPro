  ...
  async uploadBatch(
    ...
    const request: BatchUploadRequest = {
      readings: readings.map((r) => ({
        ...
        mwh: r.mwh ?? null,
        kvah: r.kvah ?? null,
        kvah_export: r.kvah_export ?? null,
        kva: r.kva ?? null,
        phase_kva_a: r.phase_kva_a ?? null,
        phase_kva_b: r.phase_kva_b ?? null,
        phase_kva_c: r.phase_kva_c ?? null,
        amperage: r.amperage ?? null,
        phase_amperage_a: r.phase_amperage_a ?? null,
        phase_amperage_b: r.phase_amperage_b ?? null,
        phase_amperage_c: r.phase_amperage_c ?? null,
        frequency: r.frequency ?? null,
        peak_kw: r.peak_kw ?? null,
        kw: r.kw ?? null,
        power_factor: r.power_factor ?? null,
        pf_a: r.pf_a ?? null,
        pf_b: r.pf_b ?? null,
        pf_c: r.pf_c ?? null,
        phase_kw_a: r.phase_kw_a ?? null,
        phase_kw_b: r.phase_kw_b ?? null,
        phase_kw_c: r.phase_kw_c ?? null,
        kvarh: r.kvarh ?? null,
        reactive_energy_export: r.reactive_energy_export ?? null,
        kvar: r.kvar ?? null,
        phase_kvar_a: r.phase_kvar_a ?? null,
        phase_kvar_b: r.phase_kvar_b ?? null,
        phase_kvar_c: r.phase_kvar_c ?? null,
        ...
        total_thdv: r.total_thdv ?? null,
        phase_thdv_a: r.phase_thdv_a ?? null,
        phase_thdv_b: r.phase_thdv_b ?? null,
        phase_thdv_c: r.phase_thdv_c ?? null,
