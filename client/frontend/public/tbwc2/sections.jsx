...
function Hero({ variant, onPortalClick }) {
  const headlineA = (
    <div className="hero__two-block">
      <div className="hero__block">
        <h2 className="hero__block-heading">
          Whether for <em>cost allocation</em>, <em>energy awareness</em>, or for <em>compliance</em>&hellip;
        </h2>
        <p>TBWC has transformed the process of submetering from selecting the meters, to delivering a fully integrated and scalable energy management tool that is easier-to-install, easier to own, and easier-to-manage over the life of the building.</p>
      </div>
      <div className="hero__block">
        <h2 className="hero__block-heading">
          From initial concept, deployment and post-installation <em>support</em>.
        </h2>
        <p>TBWC delivers owner/operators the data in the way they need to immediately put into practice and achieve the goal of submetering: Gain control of energy.</p>
      </div>
    </div>
  );
  const headlineB = (
    <h1 className="display">
      The wholesale partner<br />
      ...
      <div className="wrap">
        <div className="hero__grid">
          <div className="hero__copy">
            ...
            {headline}
            {(variant === 'B' || variant === 'C') && <p className="lede hero__lede">{lede}</p>}
        ...
        <div className="locs">
          <article className="loc">
            ...
            <address className="loc__addr">
              <strong>Corporate Mailing</strong><br />
              6130 W Flamingo Rd, Unit #256<br />
