...
function buildChartData(rows: { label_key: string | number; power: number }[], timePeriod: string, offset: number = 0): ChartData[] {
      ...
      <div className="demand-graph-inner">
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
            ...
            />
            <YAxis
              label={{ value: 'kW', angle: -90, position: 'insideLeft', offset: -5 }}
