...
export const meterReadingSchema = defineSchema({
  ...
  formFields: {
    ...
    phaseAPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase A Power Factor', dbField: 'pf_a' }),
    phaseBPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase B Power Factor', dbField: 'pf_b' }),
    phaseCPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase C Power Factor', dbField: 'pf_c' }),
