...
export const meterReadingSchema = defineSchema({
  ...
  formFields: {
    ...
    current: field({ type: FieldTypes.NUMBER, default: 0, required: false, label: 'Current', dbField: 'amperage' }),
    power: field({ type: FieldTypes.NUMBER, default: 0, required: false, label: 'Power', dbField: 'kw' }),
    ...
    phaseAPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase A Power Factor', dbField: 'power_factor_phase_a' }),
    phaseBPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase B Power Factor', dbField: 'power_factor_phase_b' }),
    phaseCPowerFactor: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Phase C Power Factor', dbField: 'power_factor_phase_c' }),
    voltageThd: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Voltage Thd', dbField: 'total_thdv' }),
    ...
    voltageThdPhaseA: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Voltage Thd Phase A', dbField: 'phase_thdv_a' }),
    voltageThdPhaseB: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Voltage Thd Phase B', dbField: 'phase_thdv_b' }),
    voltageThdPhaseC: field({ type: FieldTypes.STRING, default: '', required: false, label: 'Voltage Thd Phase C', dbField: 'phase_thdv_c' }),
