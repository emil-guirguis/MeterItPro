...
export const dashboardSchema = defineSchema({
    ...
    tab({
      ...
      sections: [
        ...
        section({ name: 'Time Frame', order: 3, fields: [
          field({ name: 'time_frame_type', order: 1, type: FieldTypes.STRING, default: 'last_month', required: true, label: 'Time Frame', dbField: 'time_frame_type', enumValues: ['today', 'last_month', 'this_month_to_date', 'since_installation', 'yearly', 'custom'], showOn: ['list', 'form'], halfWidth: true }),
        ...
        section({ name: 'Visualization', order: 4, fields: [
          field({ name: 'visualization_type', order: 1, type: FieldTypes.STRING, default: 'line', required: true, label: 'Visualization Type', dbField: 'visualization_type', enumValues: ['pie', 'line', 'candlestick', 'bar', 'area', 'list'], showOn: ['list', 'form'], halfWidth: true }),
  ...
  formFields: {
    ...
    time_frame_type: field({ type: FieldTypes.STRING, default: 'last_month', required: true, label: 'Time Frame', dbField: 'time_frame_type', enumValues: ['today', 'last_month', 'this_month_to_date', 'since_installation', 'yearly', 'custom'], showOn: ['list', 'form'], halfWidth: true }),
    ...
    visualization_type: field({ type: FieldTypes.STRING, default: 'line', required: true, label: 'Visualization Type', dbField: 'visualization_type', enumValues: ['pie', 'line', 'candlestick', 'bar', 'area', 'list'], showOn: ['list', 'form'] }),
  ...
  entityFields: {
    ...
    created_at: field({ name: 'created_at', type: FieldTypes.DATETIME, default: null, readOnly: true, label: 'Created At', dbField: 'created_at' }),
    updated_at: field({ name: 'updated_at', type: FieldTypes.DATETIME, default: null, readOnly: true, label: 'Updated At', dbField: 'updated_at' }),
