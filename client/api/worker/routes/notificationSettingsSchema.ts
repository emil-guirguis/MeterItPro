...
export const notificationSettingsSchema = defineSchema({
  ...
  entityFields: {
    id: field({ name: 'id', type: FieldTypes.STRING, label: 'ID', dbField: 'notification_setting_id', readOnly: true }),
    updated_at: field({ name: 'updated_at', type: FieldTypes.DATETIME, label: 'Last Updated', dbField: 'updated_at', readOnly: true }),
  },
        ...
        section({
          ...
          fields: [
            field({
              ...
              label: 'Enable automatic health checks', dbField: '', showOn: ['form'],
            }),
            field({
              name: 'health_check_cron', order: 2, type: FieldTypes.STRING, default: '0 * * * *', required: false,
              label: 'Health Check Schedule (cron)', dbField: 'meter_health_check_time', showOn: ['form'],
            ...
            field({
              ...
              label: 'Stale Threshold (hours)', dbField: '', min: 1, max: 168, showOn: ['form'],
            ...
            field({
              ...
              label: 'Daily Email Summary Schedule (cron)', dbField: 'daily_meter_health_email_time', showOn: ['form'],
