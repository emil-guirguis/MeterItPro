        ...
        section({
          ...
          fields: [
            ...
            field({
              ...
              dbField: 'name',
              maxLength: 255,
              placeholder: 'Auto-generated on save (sync-xxxxxx)',
              showOn: ['list', 'form'],
            }),
            field({
              name: 'timezone',
        ...
        section({
          ...
          fields: [
            field({
              ...
              dbField: 'provision_status',
              showOn: ['list', 'form'],
              enumValues: ['pending', 'provisioning', 'active', 'error'],
            }),
            field({
              name: 'tunnel_url',
              order: 2,
