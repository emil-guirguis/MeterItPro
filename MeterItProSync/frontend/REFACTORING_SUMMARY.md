...
### New Files
- `MeterItProSync/frontend/src/types/connection.ts`
- `MeterItProSync/frontend/src/components/ConnectionStatusIndicator.tsx`
- `MeterItProSync/frontend/src/hooks/useConnectionStatus.ts`

### Modified Files
- `MeterItProSync/frontend/src/components/CompanyInfoCard.tsx` (complete rewrite)
- `MeterItProSync/frontend/src/pages/SyncStatus.tsx` (major refactor)
- `MeterItProSync/frontend/src/types/index.ts` (added connection type exports)
